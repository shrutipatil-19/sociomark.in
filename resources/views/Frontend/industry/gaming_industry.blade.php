...
<main id="industries">
    <section class="p-0" style="margin-top: 66px;">
        <div class="full-width">
            <img src="{{ asset('frontend-assets/img/industry/Gaming.png') }}" alt="gaming" srcset="" class="w-100" loading="lazy">
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcumb-content breadcrumb-light">
                        <h1 class="breadcumb-title text-center text-md-start">Gaming Industry</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 mb-30 mb-xl-0">
                    <div class="imgBox img-box2 me-xl-4 mt-lg-60">
                        <div class="img1 mb-35">
                            <img src="{{ asset('frontend-assets/img/industry/images/gaming.jpg') }}" class="w-100" alt="About">
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
        ...
        <div class="container">
            ...
            <div class="">
                <div class="row justify-content-around">
                    ...
                    <div class="col-xxl-auto col-xl-3 col-lg-6 col-12">
                        <div class="counter-box">
                            <div class="box-icon"><img src="{{ asset('frontend-assets/img/icon/target.png') }}" width="60" alt="Organic Impression"></div>
            ...
            <div class="portfolio-area d-none" data-aos="zoom-in" data-aos-delay="200">
                <div class="row gy-4 filter-active garally-row-height mt-md-0 mt-4">
                    <div class="col-md-3 col-6 col-xl-auto filter-item cat5 cat1">
                        <a target="_blank" href="{{ route('social_media', ['client' => 'nodwin-gaming']) }}" class="project-item d-block">
